...
namespace Log4netFacade
{
    ...
    {
        /// <summary> The log4net log which this class wraps. </summary>
        private readonly log4net.ILog log;

        /// <summary> Constructs an instance of <see cref="Log4netLog" /> by wrapping a log4net log. </summary>
        ...
        /// <summary> Logs the given message. Output depends on the associated log4net configuration. </summary>
        ...
        /// <summary> Overriden to delegate to the log4net IsXxxEnabled properties. </summary>
