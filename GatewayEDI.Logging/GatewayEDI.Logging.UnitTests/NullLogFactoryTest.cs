...
namespace GatewayEDI.Logging.UnitTests
{
    ...
    /// <summary>
    ///This is a test class for NullLogFactoryTest and is intended
    ///to contain all NullLogFactoryTest Unit Tests
    ///</summary>
    [TestClass()]
    public class NullLogFactoryTest
    {
        ...
        /// <summary>
        ///A test for NullLogFactory Constructor
        ///</summary>
        [TestMethod()]
        ...
        {
            NullLogFactory actual;
            actual = NullLogFactory.Instance;
            Assert.Inconclusive("Verify the correctness of this test method.");
        }
    }
}
