...
namespace GatewayEDI.Logging.UnitTests
{
    ...
    /// <summary>
    ///This is a test class for SingleLineFormatterTest and is intended
    ///to contain all SingleLineFormatterTest Unit Tests
    ///</summary>
    [TestClass()]
    public class SingleLineFormatterTest
    {
        ...
        /// <summary>
        ///A test for SingleLineFormatter Constructor
        ///</summary>
        [TestMethod()]
        ...
        {
            SingleLineFormatter actual;
            actual = SingleLineFormatter.Instance;
            Assert.Inconclusive("Verify the correctness of this test method.");
        }
    }
}
